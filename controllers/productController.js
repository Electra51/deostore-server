  ...
  try {
    ...
    switch (true) {
      ...
      case !shipping_charge:
        return res.status(500).send({ error: "shipping charge is Required" });
      case !shipping_method:
        return res.status(500).send({ error: "shipping method is Required" });
  ...
  try {
    ...
    switch (true) {
      ...
      case !shipping_charge:
        return res.status(500).send({ error: "shipping charge is Required" });
      case !shipping_method:
        return res.status(500).send({ error: "shipping_method is Required" });
